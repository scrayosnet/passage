...
Clients below that version are disconnected right after login with the [`disconnect_unsupported`](/advanced/localization/#disconnect_unsupported) message, which names the version they should use instead.
