...
| Multi-version support | ✅ | ✅ | ✅ | ✅ | ⚠️ 1.20.5+ only |
| **Development** |
| Actively maintained | ❓ | ❌ | ✅ | ✅ | ✅ |
| Modern codebase | ❌ | ❌ | ✅ | ✅ | ✅ |
| Open source | ✅ | ✅ | ✅ | ✅ | ✅ |
...
- **Offline mode networks** — the `disabled` and `fixed` [authentication adapters](/adapters/authentication/) exist for local development and testing, but Passage is designed around verified Mojang identities and the signed authentication cookie, neither of which is meaningful without online mode
